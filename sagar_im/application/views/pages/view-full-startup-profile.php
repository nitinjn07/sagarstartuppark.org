                    ...
                    <div class="col-xxl-12">
                        <div class="card">
                            <div class="card-header">
                                <form action="<?=base_url();?>Dashboard/getStartupDetails" method="post">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label>Select Startup</label>
                                            <select class="form-control" name="startupid" id="startup">
                                                <option value="">Select Startup</option>
                                                <?php
                                             $startup = $this->db->get_where('startup',array('action'=>'accept','delstatus'=>1,'is_screened'=>1))->result(); 
                            ...
                            <div class="card-body">
                                <?php 
                                   if(isset($_POST['search']))
                                   {
                                    ...
                                    $startup = $this->db->get_where('startup',array('id'=>$_POST['startupid']))->row();
                                    $_SESSION['startup_name'] = $startup->startup_name;
                                    ?>

                                <h1 class="text-center py-3"><?=@$_SESSION['startup_name'];?></h1>
                                ...
                                <ul class="nav nav-tabs">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#product_service">Problem Statement</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#startup_attendance">Attendance
                                        </a>
                                    </li>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="basic_profile">
                                        <div class="row">
                                            <div class="col-lg-4">
                                                ...
                                                <?php }else {
                                                    ?>
                                                <img src="<?=base_url('Startup/assets/img/startuplogo.png'); ?>"
                                                    class="img-fluid rounded-circle mb-2"
                                            ...
                                            <div class="col-lg-8 pt-4">
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><?php if($startup->stage){ echo strtoupper(str_replace("_"," ",$startup->stage));}else { echo "Not Found"; }?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Email</td>
                                            ...
                                            echo $this->db->get_where('cities',array('id'=>$cityid))->row()->name;
                                            ...
                                            ?>
                                                    ...
                                                    <tr>
                                                        <td>Social Media</td>
                                                        <td>
                                                            <a href="<?=$startup->facebook;?>" target="_blank" class="mx-2"><i class="fa fa-facebook"></i></a>
                                                            <a href="<?=$startup->twitter;?>" target="_blank" class="mx-2"><i class="fa fa-twitter"></i></a>
                                                            <a href="<?=$startup->linkedin;?>" target="_blank" class="mx-2"><i class="fa fa-linkedin"></i></a>
                                                            <a href="<?=$startup->youtube;?>" target="_blank" class="mx-2"><i class="fa fa-youtube"></i></a>
                                                            <a href="<?=$startup->whatsapp;?>" target="_blank" class="mx-2"><i class="fa fa-whatsapp"></i></a>
                                                        </td>
                                                    </tr>
                                    ...
                                    <div class="tab-pane fade" id="screening_details">
                                        <div class="col-md-6 pt-5 shadow">
                                            ...
                                            <table class="table table-bordered">
                                                <tr>
                                                    <td>Current Stage</td>
                                                    <td><?php if($startup->im_stage){ echo str_replace("_"," ",$startup->im_stage); }else { echo "Not Found"; } ?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Startup Type</td>
                                    ...
                                    <div class="tab-pane pt-3 fade" id="founder_details">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <?php
                                            $i=1;
                                            $founder = $this->db->get_where('founders',array('startup_id'=>$startup->id))->result();
                                          ...
                                          ?>
                                            ...
                                            <tr>
                                                <td><?=$i;?></td>
                                                <td><?=$f->founderName;?></td>
                                                <td><?=$f->founderEmail;?></td>
                                                <td><?=$f->founderMobile;?></td>
                                                <td><?=$f->founderGender;?></td>
                                                <td><?=$f->founderBackground;?></td>
                                                <td><?=$f->founderEducation;?></td>
                                            </tr>
                                            <?php 
                                              $i++;
                                              }
                                    ...
                                    <div class="tab-pane pt-3 fade" id="startup_team">
                                        ...
                                        <div class="row">
                                            <?php 
                                      $teams = $this->db->get_where('team_member',array('startup_id'=>$startup->id))->result();
                                      foreach($teams as $t)
                                      {
                                     ?>
                                    ...
                                    <div class="tab-pane fade" id="startup_kra">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <td>Current Stage</td>
                                                <td><?= strtoupper(str_replace("_"," ",@$startup->im_stage));?></td>
                                            </tr>
                                            <tr>
                                                <td>Start Date</td>
                                        ...
                                        <table class="table">
                                            ...
                                            <?php 
                                          $task = $this->db->Query('select * from kra_task where startupid='.$startup->id.' and kra_id='.$kra->id)->result();      
                                          foreach($task as $t)
                                          {
                                        ?>
                                            <tr>
                                    ...
                                    <div class="tab-pane fade" id="startup_attendance">
                                        <div class="col-xxl-12">
                                            <div class="card">
                                                ...
                                                foreach($current_month as $cm)
                                                { 
                                                $status = $this->db->get_where('startup_attendance',array('startup_id'=>$startup->id,'attd_date'=>$cm))->row();
                                                if($status)
                                                {
                                                if($status->status=="P")
                                                {
                                   ...
                                   else 
                                   {
                                    if(isset($_GET['sid']))
                                    {
                                        $startup = $this->db->get_where('startup',array('id'=>$_GET['sid']))->row();
                                 ?>
                                    <ul class="nav nav-tabs">
                                        <li class="nav-item">
                                            <a class="nav-link active" data-bs-toggle="tab" href="#basic_profile">Basic
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab"
                                                href="#incubation_details">Incubation
                                                Details</a>
                                        </li>
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab"
                                                href="#revenue_details">Revenue/Funding
                                            </a>
                                        </li>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#documents">Documents
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#startup_kra">KRA </a>
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" data-bs-toggle="tab" href="#attendance1">Attendance
                                            </a>
                                        </li>
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane pt-3 fade" id="revenue_details">
                                            ...
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tbody>
                                                    <?php 
                                          $bootstrap = $this->db->get_where('bootstrap',array('startup_id'=>$_GET['sid']))->result();
                                          $i=1;
                                          foreach($bootstrap as $b)
                                          {
                                        ...
                                        ?>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php 
                                          $seed = $this->db->get('seed_funding',array('startup_id'=>$_GET['sid']))->result();
                                          $i=1;
                                          foreach($seed as $s)
                                          {
                                        ...
                                        ?>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php 
                                          $vc = $this->db->get('vc_funding',array('startup_id'=>$_GET['sid']))->result();
                                          $i=1;
                                          foreach($vc as $v)
                                          {
                                        ...
                                        ?>
                                            ...
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    <?php 
                                          $ai = $this->db->get('angel_investor',array('startup_id'=>$_GET['sid']))->result();
                                          $i=1;
                                          foreach($ai as $a)
                                          {
                                        ...
                                        ?>
                                            ...
                                            <table class="table table-bordered table-striped">
                                                ...
                                                <tbody>
                                                    <?php 
                                          $rev = $this->db->get('startup_revenue',array('startup_id'=>$_GET['sid']))->result();
                                          $i=1;
                                          foreach($rev as $r)
                                          {
                                        ...
                                        <div class="tab-pane fade" id="attendance1">
                                            <div class="col-xxl-12">
                                                <div class="card">
                                        ...
                                        <div class="tab-pane fade" id="startup_kra">
                                          ...
                                          ?>
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td>Current Stage</td>
                                                    <td><?= strtoupper(str_replace("_"," ",@$startup->im_stage));?>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Start Date</td>
                                                        ...
                                                        <div class="col-md-2 pt-3">
                                                            <div class="form-group">
                                                                <input type="submit" class="btn btn-primary btn-lg"
                                                                    value="Filter Now" name="filter_attd" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
