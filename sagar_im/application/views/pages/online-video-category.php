                    ...
                    <div class="col-xxl-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="<?=base_url();?>OnlineVideoCategory/addCategory" method="post"
                                    ...
                                    <div class="row mb-3 mt-3">
                                        ...
                                        <div class="col">
                                            <label class="pt-2 "> Tags<span class='text-danger'>*</span></label></label>
                                            <input type="text" class="form-control" placeholder="Category Tags"
                                                name="cat_tags" required />
                                        </div>
                                ...
                                <table id="datatables-buttons" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?=$i;?></td>
                                            <td><img src="<?=base_url('uploads/videocategory/').$cat->image;?>"
                                                    width="100px" height="80px" /></td>
                                            <td><?=$cat->title;?></td>
                                            <td><?=$cat->description;?></td>
                                            <td>
                                                <a href="<?=base_url();?>OnlineVideoCategory/deleteCategory?delid=<?=$cat->id;?>"
                                                    class="btn btn-danger"
                                                    onclick="return confirm('Are you sure to delete');"><i
                                                        class="fa fa-trash"></i></a>
                                                <a class="btn btn-warning" href="javascript:void(0);"
                                                    onclick="showAjaxModal('<?=base_url(); ?>Popup/index/edit-video-category/<?= $cat->id; ?>')"><i
