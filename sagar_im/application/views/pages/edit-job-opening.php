                            ...
                            <div class="card-body">
                                ...
                                <form action="<?=base_url();?>JobOpening/UpdateJobOpening" method="post"
                                        ...
                                        <div class="col">
                                            ...
                                            <select name="job_location" class="form-control" required>
                                                ...
                                                <option value="WFH"
                                                    ...
                                                    Home</option>
                                                <option value="JIC"
                                                    <?php if($job->job_location=='JIC'){echo "selected";}?>>Jabalpur
                                    ...
                                    <div class="row mb-3 mt-3">
                                        ...
                                        <div class="col">
                                            ...
                                            <select class="form-control" name="startupid" readonly>
                                                ...
                                                <?php
                                                  $startup = $this->db->get_where('startup',array('delstatus'=>1,'is_screened'=>1,'is_graduate'=>0))->result(); 
                                                  foreach($startup as $s)
                                                  {
                                                 ?>
                                                <option value="<?=$s->id;?>"
                                                    <?php if($s->id==$job->startupid){echo "selected";}?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <label class="pt-2 ">Salary Range <span class="text-danger">(*)</span></label>
