<?php 
  $category = $this->db->get_where('template_category',array('id'=>$param))->row();
?>
<form action="<?=base_url();?>TemplateCategory/updateCategory" method="post" enctype="multipart/form-data"
    ...
    <div class="row mb-3 mt-3">
        ...
        <div class="col-12">
            <img src="<?=base_url('uploads/template_category/').$category->image;?>" width="100px" height="80px" />
