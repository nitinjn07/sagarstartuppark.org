...
class PhysicalStartup extends CI_Controller {


    public function index() {
        $config = array();
        $where = array('action'=>'accept','delstatus'=>1,'startup_type'=>'Physical','is_screened'=>1,'is_graduate'=>0);
        $config["base_url"] = base_url() . "PhysicalStartup";
        ...
        $this->load->view('pages/physical-startup', $data);
    }
